...
public class UpgradeItemInfo
{
    ...
    public static readonly IDictionary<UpgradeType, UpgradeInfo> UpgradeItemInfos = new Dictionary<UpgradeType, UpgradeInfo>
    {
        ...
        {UpgradeType.BOMB_RADIUS, new(UpgradeType.BOMB_RADIUS,
                                3,
                                "UPGRADE_BOMB_RADIUS",
                                new List<string>(){"UPGRADE_BOMB_RADIUS_0",
                                                   "UPGRADE_BOMB_RADIUS_1",
                                                   "UPGRADE_BOMB_RADIUS_2",
                                                   "UPGRADE_BOMB_RADIUS_3",}.ToImmutableList(),
                                new List<int>(){0, 1, 2, 3,}.ToImmutableList(),
                                new List<string>(){"res://assets/textures/gui/upgrades/BOMB_RADIUS-0.png",
                                                   "res://assets/textures/gui/upgrades/BOMB_RADIUS-1.png",
                                                   "res://assets/textures/gui/upgrades/BOMB_RADIUS-2.png",
                                                   "res://assets/textures/gui/upgrades/BOMB_RADIUS-3.png",}.ToImmutableList())},
        {UpgradeType.BOMB_SCORE, new(UpgradeType.BOMB_SCORE,
                                ...
                                new List<int>(){0, 2, 4, 6,}.ToImmutableList(),
        ...
        {UpgradeType.BOMB_POWER, new(UpgradeType.BOMB_POWER,
                                ...
                                new List<int>(){0, 3, 6, 9,}.ToImmutableList(),
        ...
        {UpgradeType.ROCKET_SCORE, new(UpgradeType.ROCKET_SCORE,
                                3,
                                "UPGRADE_ROCKET_SCORE",
                                new List<string>(){"UPGRADE_ROCKET_SCORE_0",
                                                   "UPGRADE_ROCKET_SCORE_1",
                                                   "UPGRADE_ROCKET_SCORE_2",
                                                   "UPGRADE_ROCKET_SCORE_3",}.ToImmutableList(),
                                new List<int>(){0, 2, 4, 6,}.ToImmutableList(),
                                new List<string>(){"res://assets/textures/gui/upgrades/ROCKET_SCORE-0.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_SCORE-1.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_SCORE-2.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_SCORE-3.png",}.ToImmutableList())},
        {UpgradeType.ROCKET_POWER, new(UpgradeType.ROCKET_POWER,
                                3,
                                "UPGRADE_ROCKET_POWER",
                                new List<string>(){"UPGRADE_ROCKET_POWER_0",
                                                   "UPGRADE_ROCKET_POWER_1",
                                                   "UPGRADE_ROCKET_POWER_2",
                                                   "UPGRADE_ROCKET_POWER_3",}.ToImmutableList(),
                                new List<int>(){0, 1, 2, 3,}.ToImmutableList(),
                                new List<string>(){"res://assets/textures/gui/upgrades/ROCKET_POWER-0.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_POWER-1.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_POWER-2.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_POWER-3.png",}.ToImmutableList())},
        {UpgradeType.ROCKET_COUNT, new(UpgradeType.ROCKET_COUNT,
                                2,
                                "UPGRADE_ROCKET_COUNT",
                                new List<string>(){"UPGRADE_ROCKET_COUNT_0",
                                                   "UPGRADE_ROCKET_COUNT_1",
                                                   "UPGRADE_ROCKET_COUNT_2",}.ToImmutableList(),
                                new List<int>(){0, 5, 10,}.ToImmutableList(),
                                new List<string>(){"res://assets/textures/gui/upgrades/ROCKET_COUNT-0.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_COUNT-1.png",
                                                   "res://assets/textures/gui/upgrades/ROCKET_COUNT-2.png",}.ToImmutableList())},
